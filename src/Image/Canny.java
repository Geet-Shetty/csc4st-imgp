...
public class Canny {
    ...
    public static void applyCanny(String input, String output) throws IOException {
        Canny canny = null;
        Image picture = new Image();
        picture.loadImage(input);
        int[][][] RGB = picture.getImage();
        int lines = RGB[0].length;
        int samples = RGB[0][0].length;

        canny = new Canny(RGB[0]);

        canny.SetThresholds(0, 2);
    ...
    public static void main(String[] args) throws IOException {
        ...
        Canny canny = null;
        Image picture = new Image();
        picture.loadImage("D:/stuff/image/greytest2.png");
        int[][][] RGB = picture.getImage();
        int lines = RGB[0].length;
        int samples = RGB[0][0].length;
...
// -- set very low thresholds just to see what happens
        ...
        picture.saveImage("D:/stuff/image/cannytest.png", "PNG");
    }
