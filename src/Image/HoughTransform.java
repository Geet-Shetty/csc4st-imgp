...
//                else
    ...
    public static ArrayData toArrayData(Image i){
        int[][][] ch = i.getImage();
        int[] data = new int[i.getHeight() * i.getWidth()];
        for(int y = 0; y < i.getHeight(); y++){
            for(int x = 0; x < i.getWidth(); x++){
                data[y * i.getWidth() + x] = ch[0][y][x];
            }
        }
        return new ArrayData(data,i.getWidth(),i.getHeight());
    }
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        Canny.applyCanny("D:/stuff/image/CleanedCafeWall.png","D:/stuff/image/CannyCafeWall.png");

        pic.loadImage("D:/stuff/image/CannyCafeWall.png");
        ArrayData inputData =  toArrayData(pic);
        int minContrast = 100;
        ArrayData outputData = houghTransform(inputData, 360, 480, minContrast);
        writeOutputImage("D:/stuff/image/CannyCafeWallHOUGH.png", outputData);
    }
}
